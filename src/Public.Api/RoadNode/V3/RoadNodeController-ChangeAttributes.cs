namespace Public.Api.RoadNode.V3
{
    ...
    {
        private const string ChangeRoadNodeAttributesRoute = "wegknopen/acties/wijzigen/attributen";

        /// <summary>
        ///     Wijzig attribuutwaarde(n) voor één of meerdere wegknopen. (v3)
        /// </summary>
        ...
        [HttpPost(ChangeRoadNodeAttributesRoute, Name = nameof(ChangeRoadNodeAttributesV3))]
        [ApiOrder(ApiOrder.Road.RoadNode.ChangeAttributes)]
        ...
        public async Task<IActionResult> ChangeRoadNodeAttributesV3(
            ...
            [FromServices] ChangeRoadNodeAttributesV3Toggle featureToggle,
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRestRequest(Method.Post, ChangeRoadNodeAttributesRoute)
                    .AddJsonBody(request);
