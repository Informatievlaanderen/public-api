namespace Public.Api.PostalCode.Oslo
{
    ...
    {
        /// <summary>
        /// Vraag het totaal aantal postinfo over postcodes op (v2).
        /// </summary>
        ...
        [HttpGet("postinfo/totaal-aantal", Name = nameof(CountPostalCodesV2))]
        [ApiOrder(ApiOrder.PostalCode.V2 + 3)]
        ...
        public async Task<IActionResult> CountPostalCodesV2(
