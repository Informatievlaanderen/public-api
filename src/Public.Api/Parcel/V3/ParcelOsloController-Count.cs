namespace Public.Api.Parcel.V3
{
    ...
    using ParcelRegistry.Api.Oslo.Parcel.V3.Count;
    using RestSharp;
    ...
    {
        /// <summary>
        /// Vraag het totaal aantal percelen op (v3).
        /// </summary>
        ...
        [HttpGet("percelen/totaal-aantal", Name = nameof(CountParcelsV3))]
        [ApiOrder(ApiOrder.Parcel.V3 + 3)]
        ...
        public async Task<IActionResult> CountParcelsV3(
