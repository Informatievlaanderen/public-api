namespace Public.Api.Notifications
{
    ...
    public partial class NotificationsController
    {
        ...
        /// <response code="204">Als de intrekking van de notificatie gelukt is.</response>
        ...
        [HttpPost("notificaties/{id}/acties/intrekken", Name = nameof(UnpublishNotification))]
        [ApiOrder(ApiOrder.Notifications + 4)]
