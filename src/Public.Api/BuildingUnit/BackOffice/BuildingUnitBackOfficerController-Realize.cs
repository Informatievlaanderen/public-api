namespace Public.Api.BuildingUnit.BackOffice
{
    ...
    public partial class BuildingUnitBackOfficeController
    {
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.BuildingUnit.Edit + 2)]
        ...
        [SwaggerAuthorizeOperation(
            Description = "Wijzig de gebouweenheidstatus van `gepland` naar `gerealiseerd`.",
        ...
        public async Task<IActionResult> RealizeBuildingUnit(
            ...
            [FromServices] RealizeBuildingUnitToggle realizeBuildingUnitToggle,
