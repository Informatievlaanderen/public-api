namespace Public.Api.BuildingUnit.BackOffice
{
    ...
    public partial class BuildingUnitBackOfficeController
    {
        ...
        /// <summary>
        /// Koppel een adres aan een gebouweenheid  (v2).
        /// </summary>
        ...
        [SwaggerAuthorizeOperation(
            Description = "Koppel een adresId met status `voorgesteld` of `inGebruik` aan een gebouweenheid met status `gepland` of `gerealiseerd`.",
