namespace Public.Api.BuildingUnit.BackOffice
{
    ...
    {
        public const string ChangeBuildingUnitFunctionRoute = "gebouweenheden/{objectId}/acties/wijzigen/functie";
        ...
        /// <param name="changeBuildingUnitFunctionToggle"></param>
        ...
        [SwaggerOperation(Description = "De functie van een gebouweenheid wijzigen.")]
        [HttpPost(CorrectBuildingUnitPositionRoute, Name = nameof(ChangeBuildingUnitFunction))]
        public async Task<IActionResult> ChangeBuildingUnitFunction(
            [FromRoute] int objectId,
            [FromBody] ChangeBuildingUnitFunctionRequest changeBuildingUnitFunctionRequest,
            [FromServices] IActionContextAccessor actionContextAccessor,
            [FromServices] ProblemDetailsHelper problemDetailsHelper,
            [FromServices] ChangeBuildingUnitFunctionToggle changeBuildingUnitFunctionToggle,
            [FromHeader(Name = HeaderNames.IfMatch)] string? ifMatch,
            CancellationToken cancellationToken = default)
        {
            if (!changeBuildingUnitFunctionToggle.FeatureEnabled)
            {
                return NotFound();
            }
            ...
            RestRequest BackendRequest() =>
                CreateBackendRequestWithJsonBody(CorrectBuildingUnitPositionRoute, changeBuildingUnitFunctionRequest, Method.Post)
