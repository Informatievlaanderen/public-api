namespace Public.Api.BuildingUnit.BackOffice
{
    ...
    {
        public const string CorrectBuildingUnitRemovalRoute = "gebouweenheden/{objectId}/acties/corrigeren/verwijdering";

        /// <summary>
        /// Corrigeer de verwijdering van een gebouweenheid (v2).
        /// </summary>
        /// <param name="objectId">Identificator van de gebouweenheid.</param>
        /// <param name="actionContextAccessor"></param>
        /// <param name="problemDetailsHelper"></param>
        /// <param name="correctBuildingUnitRemovalToggle"></param>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.BuildingUnit.Edit + 16)]
        ...
        [SwaggerOperation(Description = "Correctie van de verwijdering van een gebouweenheid. Er wordt automatisch een gemeenschappelijkDeel aangemaakt vanaf dat er 2 gebouweenheden met status `gepland` of `gerealiseerd` aan een gebouw gekoppeld zijn. De status van het gemeenschappelijkDeel is `gerealiseerd`. <br>" +
        ...
        public async Task<IActionResult> CorrectBuildingUnitRemoval(
            ...
            [FromServices] CorrectBuildingUnitRemovalToggle correctBuildingUnitRemovalToggle,
            [FromHeader(Name = HeaderNames.IfMatch)] string? ifMatch,
            CancellationToken cancellationToken = default)
        {
            if (!correctBuildingUnitRemovalToggle.FeatureEnabled)
            {
                return NotFound();
            }
            ...
            RestRequest BackendRequest() => new RestRequest(CorrectBuildingUnitRemovalRoute, Method.Post)
