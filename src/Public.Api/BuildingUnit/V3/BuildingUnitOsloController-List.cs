namespace Public.Api.BuildingUnit.V3
{
    ...
    using BuildingRegistry.Api.Oslo.BuildingUnit.V3.List;
    ...
    {
        /// <summary>
        /// Vraag een lijst met gebouweenheden op (v3).
        /// </summary>
        ...
        [HttpGet("gebouweenheden", Name = nameof(ListBuildingUnitsV3))]
        [ApiOrder(ApiOrder.BuildingUnit.V3 + 2)]
        ...
        public async Task<IActionResult> ListBuildingUnitsV3(
