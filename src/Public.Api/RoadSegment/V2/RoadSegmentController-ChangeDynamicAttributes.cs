namespace Public.Api.RoadSegment.V2
{
    ...
    public partial class RoadSegmentControllerV2
    {
        ...
        /// <summary>
        ///     Wijzig een dynamisch attribuut voor één of meerdere wegsegmenten (v2).
        /// </summary>
        ...
        [ApiOrder(ApiOrder.Road.RoadSegment.ChangeDynamicAttributes)]
            ...
            CancellationToken cancellationToken)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRestRequest(Method.Post, ChangeRoadSegmentDynamicAttributesRoute)
                    .AddJsonBody(request);
