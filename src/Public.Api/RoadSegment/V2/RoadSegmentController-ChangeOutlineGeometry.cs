namespace Public.Api.RoadSegment.V2
{
    ...
    public partial class RoadSegmentControllerV2
    {
        ...
        /// <summary>
        ///     Wijzig de geometrie van een ingeschetst wegsegment (v2).
        /// </summary>
        ...
        [ApiOrder(ApiOrder.Road.RoadSegment.ChangeOutlineGeometry)]
            ...
            CancellationToken cancellationToken)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRestRequest(Method.Post, ChangeRoadSegmentOutlineGeometryRoute)
                    .AddJsonBody(request)
