namespace Public.Api.RoadSegment.V3
{
    ...
    public partial class RoadSegmentControllerV3
    {
        ...
        /// <summary>
        ///     Verwijder één of meerdere wegsegmenten. (v3)
        /// </summary>
        /// <param name="request">Objectidentificatoren van de wegsegmenten.</param>
        ...
        [HttpPost(DeleteRoadSegmentsRoute, Name = nameof(DeleteRoadSegmentsV3))]
        ...
        public async Task<IActionResult> DeleteRoadSegmentsV3(
            ...
            [FromServices] DeleteRoadSegmentsV3Toggle featureToggle,
