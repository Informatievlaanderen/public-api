namespace Public.Api.RoadSegment.V3
{
    ...
    {
        private const string FromPlannedToNotRealizedRoadSegmentRoute = "wegsegmenten/{id}/acties/geplandnaarnietgerealiseerd";

        /// <summary>
        ///     Markeer een gepland wegsegment als niet gerealiseerd. (v3)
        /// </summary>
        /// <param name="id"></param>
        ...
        [HttpPost(FromPlannedToNotRealizedRoadSegmentRoute, Name = nameof(ChangeRoadSegmentFromPlannedToNotRealizedV3))]
        [ApiOrder(ApiOrder.Road.RoadSegment.ChangeFromPlannedToNotRealized)]
        ...
        [SwaggerAuthorizeOperation(
            OperationId = nameof(ChangeRoadSegmentFromPlannedToNotRealizedV3),
            Description = "Markeer een `gepland` wegsegment als `niet gerealiseerd`. Zowel de oude als de nieuwe status houden het wegsegment buiten het wegennet, dus enkel de status wijzigt: de geometrie, de attributen en de wegknopen blijven ongemoeid.",
            Authorize = Scopes.DvWrGeschetsteWegBeheer
        )]
        public async Task<IActionResult> ChangeRoadSegmentFromPlannedToNotRealizedV3(
            [FromRoute] int id,
            [FromServices] ProblemDetailsHelper problemDetailsHelper,
            [FromServices] RoadSegmentChangeFromPlannedToNotRealizedV3Toggle featureToggle,
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRestRequest(Method.Post, FromPlannedToNotRealizedRoadSegmentRoute)
