namespace Public.Api.RoadSegment.V3
{
    ...
    public partial class RoadSegmentControllerV3
    {
        ...
        [HttpPost(ChangeFromOutOfUseToHistorizedRoadSegmentRoute, Name = nameof(ChangeRoadSegmentFromOutOfUseToHistorizedV3))]
        [ApiOrder(ApiOrder.Road.RoadSegment.ChangeFromOutOfUseToHistorized)]
        ...
        [SwaggerAuthorizeOperation(
            OperationId = nameof(ChangeRoadSegmentFromOutOfUseToHistorizedV3),
            Description = "Markeer een `buiten gebruik` wegsegment als `gehistoreerd`. Zowel de oude als de nieuwe status houden het wegsegment buiten het wegennet, dus enkel de status wijzigt: de geometrie, de attributen en de wegknopen blijven ongemoeid.",
            Authorize = Scopes.DvWrGeschetsteWegBeheer
        )]
        public async Task<IActionResult> ChangeRoadSegmentFromOutOfUseToHistorizedV3(
            [FromRoute] int id,
            [FromServices] ProblemDetailsHelper problemDetailsHelper,
            [FromServices] RoadSegmentChangeFromOutOfUseToHistorizedV3Toggle featureToggle,
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRestRequest(Method.Post, ChangeFromOutOfUseToHistorizedRoadSegmentRoute)
