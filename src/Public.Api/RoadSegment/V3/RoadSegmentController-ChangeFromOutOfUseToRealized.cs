namespace Public.Api.RoadSegment.V3
{
    ...
    public partial class RoadSegmentControllerV3
    {
        ...
        [HttpPost(ChangeFromOutOfUseToRealizedRoadSegmentRoute, Name = nameof(ChangeRoadSegmentFromOutOfUseToRealizedV3))]
        [ApiOrder(ApiOrder.Road.RoadSegment.ChangeFromOutOfUseToRealized)]
        ...
        public async Task<IActionResult> ChangeRoadSegmentFromOutOfUseToRealizedV3(
            ...
            [FromServices] RoadSegmentChangeFromOutOfUseToRealizedV3Toggle featureToggle,
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRestRequest(Method.Post, ChangeFromOutOfUseToRealizedRoadSegmentRoute)
