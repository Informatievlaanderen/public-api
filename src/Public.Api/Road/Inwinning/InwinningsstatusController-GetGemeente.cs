namespace Public.Api.Road.Inwinning
{
    ...
    {
        /// <summary>
        ///     Vraag de inwinningsstatus van een gemeente op (v2).
        /// </summary>
        /// <param name="nisCode">De NIS-code van de gemeente/stad.</param>
        ...
        [AllowAnonymous]
        [HttpGet("wegen/inwinningsstatus/gemeente/{nisCode}", Name = nameof(GetGemeenteInwinningsstatus))]
        ...
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(GemeenteInwinningsstatusResponseExamples))]
        ...
        public async Task<ActionResult> GetGemeenteInwinningsstatus(
            [FromRoute] string nisCode,
            [FromServices] ProblemDetailsHelper problemDetailsHelper,
            [FromServices] RoadInwinningsstatusGemeenteToggle featureToggle,
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRestRequest(Method.Get, $"inwinningsstatus/gemeente/{nisCode}");
        }
    }
}
