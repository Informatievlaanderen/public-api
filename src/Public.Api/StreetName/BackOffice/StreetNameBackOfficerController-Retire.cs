namespace Public.Api.StreetName.BackOffice
{
    ...
    public partial class StreetNameBackOfficeController
    {
        ...
        /// <response code="202">Als de straatnaam succesvol opgeheven is.</response>
        ...
        [SwaggerResponseHeader(StatusCodes.Status202Accepted, "location", "string", "De URL van de opgeheven straatnaam.", "")]
