namespace Public.Api.StreetName.BackOffice
{
    ...
    {
        public const string RenameStreetNameRoute = "straatnamen/{objectId}/acties/hernoemen";

        /// <summary>
        /// Hernoem de straatnaam van een straatnaam (v2).
        /// </summary>
        /// <param name="objectId">Identificator van de straatnaam.</param>
        /// <param name="request"></param>
        /// <param name="actionContextAccessor"></param>
        /// <param name="problemDetailsHelper"></param>
        /// <param name="renameStreetNameToggle"></param>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.StreetName.Edit + 11)]
        ...
        public async Task<IActionResult> RenameStreetName(
            ...
            [FromServices] RenameStreetNameToggle renameStreetNameToggle,
            [FromHeader(Name = HeaderNames.IfMatch)] string? ifMatch,
            CancellationToken cancellationToken = default)
        {
            if (!renameStreetNameToggle.FeatureEnabled)
            {
                return NotFound();
            }
            ...
            RestRequest BackendRequest() =>
                CreateBackendRequestWithJsonBody(RenameStreetNameRoute, request, Method.Post)
