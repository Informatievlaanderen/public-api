namespace Public.Api.StreetName.BackOffice
{
    ...
    public partial class StreetNameBackOfficeController
    {
        ...
        /// <response code="202">Als de straatnaam succesvol afgekeurd is.</response>
        ...
        [SwaggerResponseHeader(StatusCodes.Status202Accepted, "location", "string", "De URL van de afgekeurde straatnaam.", "")]
        ...
        [SwaggerOperation(Description = "Wijzig de straatnaamstatus van `voorgesteld` naar `afgekeurd`.")]
        [HttpPost("straatnamen/{objectId}/acties/afkeuren", Name = nameof(RejectStreetName))]
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                var request = new RestRequest("straatnamen/{persistentLocalId}/acties/afkeuren", Method.POST);
