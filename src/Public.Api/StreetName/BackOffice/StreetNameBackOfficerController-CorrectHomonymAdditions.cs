namespace Public.Api.StreetName.BackOffice
{
    ...
    public partial class StreetNameBackOfficeController
    {
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.StreetName.Edit + 7)]
        ...
        public async Task<IActionResult> CorrectStreetNameHomonymAdditions(
            ...
            [FromServices] CorrectStreetNameHomonymAdditionsToggle toggle,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                CreateBackendRequestWithJsonBody(CorrectStreetNameHomonymAdditionsRoute, request, Method.Post)
