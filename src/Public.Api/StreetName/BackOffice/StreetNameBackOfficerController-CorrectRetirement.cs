namespace Public.Api.StreetName.BackOffice
{
    ...
    public partial class StreetNameBackOfficeController
    {
        ...
        /// <summary>
        /// Corrigeer de opheffing van een straatnaam  (v2).
        /// </summary>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.StreetName.Edit + 10)]
        ...
        [SwaggerAuthorizeOperation(
            Description = "Correctie van de straatnaamstatus van `gehistoreerd` naar `inGebruik`. Gekoppelde adressen corrigeren niet mee van status.",
