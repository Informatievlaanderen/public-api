namespace Public.Api.StreetName.BackOffice
{
    ...
    public partial class StreetNameBackOfficeController
    {
        ...
        [SwaggerOperation(Description = "Correctie van de straatnaamstatus van `inGebruik` naar `voorgesteld`.")]
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                var request = new RestRequest(CorrectStreetNameApprovalRoute, Method.Post);
