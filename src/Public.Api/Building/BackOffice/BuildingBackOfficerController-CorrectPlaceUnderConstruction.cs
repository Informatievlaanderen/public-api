namespace Public.Api.Building.BackOffice
{
    ...
    public partial class BuildingBackOfficeController
    {
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Building.Edit + 60)]
        ...
        [SwaggerAuthorizeOperation(
            Description = "Correctie van de gebouwstatus van `inAanbouw` naar `gepland`. Gekoppelde gebouweenheden corrigeren niet mee van status.",
