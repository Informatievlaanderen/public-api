namespace Public.Api.Building.BackOffice
{
    ...
    {
        public const string RealizeBuildingRoute = "gebouwen/{objectId}/acties/realiseren";

        /// <summary>
        /// Realiseer een gebouw (v2).
        /// </summary>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Building.Edit + 30)]
        ...
        [SwaggerOperation(Description = "Wijzig de gebouwstatus van `inAanbouw` naar `gerealiseerd`. Gekoppelde gebouweenheden met status `gepland` worden `gerealiseerd`.")]
        [HttpPost(RealizeBuildingRoute, Name = nameof(RealizeBuilding))]
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() => new RestRequest(RealizeBuildingRoute, Method.Post)
