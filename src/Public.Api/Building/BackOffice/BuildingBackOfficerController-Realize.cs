namespace Public.Api.Building.BackOffice
{
    ...
    public partial class BuildingBackOfficeController
    {
        ...
        /// <response code="202">Als de aanvraag om het gebouw te realizeren succesvol is.</response>
        ...
        [SwaggerResponseHeader(StatusCodes.Status202Accepted, "location", "string", "De URL van het gerealizeerde gebouw.", "")]
