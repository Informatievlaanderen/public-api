namespace Public.Api.Building.BackOffice
{
    ...
    {
        public const string RemoveMeasuredBuildingRoute = "gebouwen/{objectId}/acties/verwijder-ingemeten";

        /// <summary>
        /// Verwijder een ingemeten gebouw (v2).
        /// </summary>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Building.Edit + 51)]
