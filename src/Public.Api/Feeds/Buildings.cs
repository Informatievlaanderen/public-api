namespace Public.Api.Feeds
{
    ...
    public partial class FeedController
    {
        ...
        /// <response code="200">Als de opvraging van een lijst met wijzigingen op gebouwen/gebouweenheden gelukt is.</response>
        ...
        /// <response code="406">Als het gevraagde formaat niet beschikbaar is.</response>
        /// <response code="500">Als er een interne fout is opgetreden.</response>
        [HttpGet("gebouwen.{format}", Name = nameof(GetBuildingsFeedWithFormat))]
