namespace Public.Api.Feeds
{
   ...
   using ProblemDetails = Be.Vlaanderen.Basisregisters.BasicApiProblem.ProblemDetails;
    ...
    {
        /// <summary>
        /// Vraag een lijst met wijzigingen op postinfo op in het Atom formaat.
        /// </summary>
        ...
        public async Task<IActionResult> GetPostalCodesFeed(
            ...
            => await GetPostalCodesFeedWithFormat(
                null,
        ...
        /// <response code="406">Als het gevraagde formaat niet beschikbaar is.</response>
        /// <response code="500">Als er een interne fout is opgetreden.</response>
        [HttpGet("postinfo.{format}", Name = nameof(GetPostalCodesFeedWithFormat))]
