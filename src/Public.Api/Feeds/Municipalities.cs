namespace Public.Api.Feeds
{
    ...
    {
        /// <summary>
        /// Vraag een lijst met wijzigingen op gemeenten op in het Atom formaat.
        /// </summary>
        ...
        [HttpGet("gemeenten", Name = nameof(GetMunicipalitiesFeed))]
        ...
        /// <summary>
        /// Vraag een lijst met wijzigingen op gemeenten op in het XML of Atom formaat.
        /// </summary>
        ...
        /// <response code="406">Als het gevraagde formaat niet beschikbaar is.</response>
        /// <response code="500">Als er een interne fout is opgetreden.</response>
        [HttpGet("gemeenten.{format}", Name = nameof(GetMunicipalitiesFeedWithFormat))]
