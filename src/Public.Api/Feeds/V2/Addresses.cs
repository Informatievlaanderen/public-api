namespace Public.Api.Feeds.V2
{
    ...
    using AddressRegistry.Api.Oslo.Address.V2.Sync;
    ...
    {
        /// <summary>
        /// Vraag een lijst met wijzigingen op adressen op in het XML of Atom formaat (v2).
        /// </summary>
        ...
        [HttpGet("adressen", Name = nameof(GetAddressesFeedV2))]
