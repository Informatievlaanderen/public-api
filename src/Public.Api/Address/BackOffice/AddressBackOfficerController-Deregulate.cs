namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        /// <summary>
        /// Deregulariseer een adres (v2).
        /// </summary>
        /// <param name="objectId">Identificator van het adres.</param>
        /// <param name="actionContextAccessor"></param>
        /// <param name="problemDetailsHelper"></param>
        /// <param name="deregulateAddressToggle"></param>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Address.Edit + 7)]
        ...
        [SwaggerOperation(Description = "Wijzig officieelToegekend van een adres van `true` naar `false`. Wanneer de status van het adres `voorgesteld` is, zal de status wijzigen naar `inGebruik`. Gekoppelde busnummers wijzigen niet mee van status.")]
        ...
        public async Task<IActionResult> DeregulateAddress(
            ...
            [FromServices] DeregulateAddressToggle deregulateAddressToggle,
            [FromHeader(Name = HeaderNames.IfMatch)] string? ifMatch,
            CancellationToken cancellationToken = default)
        {
            if (!deregulateAddressToggle.FeatureEnabled)
            {
                return NotFound();
            }
            ...
            RestRequest BackendRequest() => new RestRequest(DeregulateRoute, Method.Post)
