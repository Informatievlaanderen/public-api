namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        /// <response code="202">Als het adres succesvol gederegulariseerd is.</response>
        ...
        [SwaggerResponseHeader(StatusCodes.Status202Accepted, "location", "string", "De URL van het gederegulariseerde adres.", "")]
