namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        [SwaggerAuthorizeOperation(
            Description = "Wijzig officieelToegekend van een adres van `false` naar `true`. Gekoppelde busnummers wijzigen niet mee van status.",
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() => new RestRequest(RegularizeRoute, Method.Post)
