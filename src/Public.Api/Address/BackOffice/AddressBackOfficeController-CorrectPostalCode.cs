namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Address.Edit + 10)]
        ...
        [SwaggerAuthorizeOperation(
            Description = "Correctie van de postinfoId van een adres. Gekoppelde busnummers worden ook gecorrigeerd naar het nieuwe postinfoId. Het postinfoId moet in de gekoppelde gemeente van het adres liggen.",
