namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        /// <summary>
        /// Corrigeer de afkeuring van een adres (v2).
        /// </summary>
        ...
        [SwaggerAuthorizeOperation(
            Description = "Correctie van de adresstatus van `afgekeurd` naar `voorgesteld`. Gekoppelde busnummers corrigeren niet mee van status.",
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                new RestRequest(CorrectRejectionRoute, Method.Post)
