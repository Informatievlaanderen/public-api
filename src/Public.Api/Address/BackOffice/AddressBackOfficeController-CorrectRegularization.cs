namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Address.Edit + 18)]
        ...
        [SwaggerAuthorizeOperation(
            Description = "Corrigeer officieelToegekend van een adres van `true` naar `false`. Wanneer de status van het adres `voorgesteld` is, zal de status wijzigen naar `inGebruik`. Gekoppelde busnummers wijzigen niet mee van status.",
        ...
        public async Task<IActionResult> CorrectRegularizationAddress(
            ...
            [FromServices] CorrectRegularizationAddressToggle toggle,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() => new RestRequest(CorrectRegularizationRoute, Method.Post)
