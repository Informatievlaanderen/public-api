namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        [SwaggerAuthorizeOperation(
            Description = "Wijzig de adresstatus van `inGebruik` naar `gehistoreerd`. Gekoppelde busnummers met status `voorgesteld` worden `afgekeurd` en gekoppelde busnummers met status `inGebruik` worden `gehistoreerd`. Als er een gebouweenheid of perceel gekoppeld is aan het adres, wordt deze koppeling verwijderd.",
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() => new RestRequest(RetireRoute, Method.Post)
