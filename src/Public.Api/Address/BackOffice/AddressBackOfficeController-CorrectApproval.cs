namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Address.Edit + 14)]
        ...
        [SwaggerOperation(Description = "Correctie van de adresstatus van `inGebruik` naar `voorgesteld`. Gekoppelde busnummers met status `inGebruik` worden `voorgesteld.`")]
        [HttpPost(CorrectApprovalRoute, Name = nameof(CorrectApprovalAddress))]
        public async Task<IActionResult> CorrectApprovalAddress(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() =>
                new RestRequest(CorrectApprovalRoute, Method.Post)
