namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        /// <response code="202">Als het adres succesvol verwijderd is.</response>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Address.Edit + 5)]
        ...
        [SwaggerResponseHeader(StatusCodes.Status202Accepted, "location", "string", "De URL van het verwijderde adres.", "")]
        ...
        {
            if (!removeAddressToggle.FeatureEnabled)
            {
                return NotFound();
            }
            ...
            {
                var request = new RestRequest(RemoveAddressRoute, Method.POST);
