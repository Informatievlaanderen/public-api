namespace Public.Api.Address.BackOffice
{
    ...
    public partial class AddressBackOfficeController
    {
        ...
        [SwaggerAuthorizeOperation(
            Description = "Wijzig officieelToegekend van een adres van `true` naar `false`. Wanneer de status van het adres `voorgesteld` is, zal de status wijzigen naar `inGebruik`. Gekoppelde busnummers wijzigen niet mee van status.",
