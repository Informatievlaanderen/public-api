namespace Public.Api.Address.BackOffice
{
    ...
    {
        public const string CorrectDeregulationRoute = "adressen/{objectId}/acties/corrigeren/deregularisatie";

        /// <summary>
        /// Corrigeer de deregularisatie van een adres (v2).
        /// </summary>
        ...
        /// <returns></returns>
        [ApiOrder(ApiOrder.Address.Edit + 19)]
        ...
        public async Task<IActionResult> CorrectDeregulationAddress(
            ...
            [FromServices] CorrectDeregulationAddressToggle toggle,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RestRequest BackendRequest() => new RestRequest(CorrectDeregulationRoute, Method.Post)
