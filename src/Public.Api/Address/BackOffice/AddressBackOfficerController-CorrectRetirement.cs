namespace Public.Api.Address.BackOffice
{
    ...
    {
        public const string CorrectRetirementRoute = "adressen/{objectId}/acties/corrigeren/opheffing";
        ...
        [SwaggerOperation(Description = "Correctie van de adresstatus van “gehistoreerd” naar “in gebruik”.")]
        ...
        public async Task<IActionResult> CorrectRetirement(
            ...
            [FromServices] CorrectRetirementAddressToggle featureToggle,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                var request = new RestRequest(CorrectRetirementRoute, Method.POST);
