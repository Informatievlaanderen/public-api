...
{
    public class HttpCacheHeaderWithExclusionsMiddleware
    {
        ...
        private readonly ExcludedRouteModelOptions _excludedRouteModelOptions;
...
namespace Marvin.Cache.Headers.Extensions
{
    ...
    {
        internal static readonly string ContextItemsExpirationModelOptions =
            "HttpCacheHeadersMiddleware-ExpirationModelOptions";
