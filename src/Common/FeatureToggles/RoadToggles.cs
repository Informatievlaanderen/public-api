namespace Common.FeatureToggles
{
    ...
    public sealed class SplitRoadSegmentV3Toggle : KeyedFeatureToggleBase, IKeyedFeatureToggle
    {
        public override string Key => "RoadSegmentSplitV3";

        public SplitRoadSegmentV3Toggle(IDynamicFeatureToggleService? dynamicFeatureToggleService)
            : base(dynamicFeatureToggleService)
        { }
    }

    public sealed class RoadSegmentSplitByJunctionV3Toggle : KeyedFeatureToggleBase, IKeyedFeatureToggle
    {
        public override string Key => "RoadSegmentSplitByJunctionV3";

        public RoadSegmentSplitByJunctionV3Toggle(IDynamicFeatureToggleService? dynamicFeatureToggleService)
            : base(dynamicFeatureToggleService)
        { }
    }

    public sealed class RoadSegmentChangeGeometryV3Toggle : KeyedFeatureToggleBase, IKeyedFeatureToggle
    {
        public override string Key => "RoadSegmentChangeGeometryV3";

        public RoadSegmentChangeGeometryV3Toggle(IDynamicFeatureToggleService? dynamicFeatureToggleService)
            : base(dynamicFeatureToggleService)
        { }
    }
    ...
    public sealed class ChangeRoadSegmentAttributesV3Toggle : KeyedFeatureToggleBase, IKeyedFeatureToggle
    {
        ...
        public ChangeRoadSegmentAttributesV3Toggle(IDynamicFeatureToggleService? dynamicFeatureToggleService)
            : base(dynamicFeatureToggleService)
        { }
    }
